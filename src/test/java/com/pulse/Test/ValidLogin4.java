	    ...
	    public void TC7(Method method) throws Exception {
		   ...
		   driver.navigate().to(appURL3);
	          childTest.get().log(Status.INFO, "Running "+method.getName());
			   ...
			   childTest.get().log(Status.INFO, "Logged into "+appURL3);
	   ...
	   */
	   ...
	   @Test
	    public void TC8(Method method) throws Exception {
		   ...
		   String expectedTitle = "Budget 2019 Highlights - Piyush Goyal Budget Speesh, Budget Impact and Analysis on The Economic Times";
		   assertEquals(actualTitle,expectedTitle);
		   
		   childTest.get().log(Status.INFO, "Verifying Title "+appURL2);
